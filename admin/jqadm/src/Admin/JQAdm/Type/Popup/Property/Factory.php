...
/**
 * Factory for popup property type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a popup property type client object
	 *
	...
	{
		/** admin/jqadm/type/popup/property/name
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Popup\Propertytype\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Popup\Propertytype\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/type/popup/property/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/type/popup/property/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Type\\Popup\\Property\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'type/popup/property' );
	}
