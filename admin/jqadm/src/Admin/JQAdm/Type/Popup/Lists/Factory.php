...
/**
 * Factory for popup lists type JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
...
{
	/**
	 * Creates a popup lists type client object
	 *
	...
	{
		/** admin/jqadm/type/popup/lists/name
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Popup\Lists\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Popup\Lists\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/type/popup/lists/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/type/popup/lists/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Type\\Popup\\Lists\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'type/popup/lists' );
	}
