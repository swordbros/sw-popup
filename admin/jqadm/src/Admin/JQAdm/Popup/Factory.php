...
/**
 * Factory for popup JQAdm client
 *
 * @package Admin
 * @subpackage JQAdm
 */
	...
	implements \Aimeos\Admin\JQAdm\Common\Factory\Iface
{
	...
	public static function create( \Aimeos\MShop\Context\Item\Iface $context, string $name = null ) : \Aimeos\Admin\JQAdm\Iface
	{
		 ...
		 *
		 *  \Aimeos\Admin\JQAdm\Popup\Standard
		 *
		 * and you want to replace it with your own version named
		 *
		 *  \Aimeos\Admin\JQAdm\Popup\Myfavorite
		 *
		 * then you have to set the this configuration option:
		 *
		 *  admin/jqadm/popup/name = Myfavorite
		 *
		 ...
		 */
		if( $name === null ) {
			$name = $context->getConfig()->get( 'admin/jqadm/popup/name', 'Standard' );
		}

		$iface = '\\Aimeos\\Admin\\JQAdm\\Iface';
		$classname = '\\Aimeos\\Admin\\JQAdm\\Popup\\' . $name;
		...
		return self::addClientDecorators( $context, $client, 'popup' );
	}
