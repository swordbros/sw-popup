...
namespace Aimeos\Admin\JQAdm\Popup\Price\Property;
...
{
	/** admin/jqadm/popup/price/property/name
	 * Name of the property subpart used by the JQAdm popup price implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Popup\Price\Property\Myname".
	...
	{
		/** admin/jqadm/popup/price/property/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/popup/price/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/popup/price/property/decorators/global
		 * @see admin/jqadm/popup/price/property/decorators/local
		 */

		/** admin/jqadm/popup/price/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/popup/price/property/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/popup/price/property/decorators/excludes
		 * @see admin/jqadm/popup/price/property/decorators/local
		 */

		/** admin/jqadm/popup/price/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/popup/price/property/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/popup/price/property/decorators/global
		 */
		return $this->createSubClient( 'popup/price/property/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/popup/price/property/subparts
		 * List of JQAdm sub-clients rendered within the popup price property section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/popup/price/property/subparts', [] );
	}
	...
	{
		/** admin/jqadm/popup/price/property/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/popup/price/property/template-item';
		$default = 'popup/item-price-property-standard';
