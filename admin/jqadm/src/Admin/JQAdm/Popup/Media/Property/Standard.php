...
namespace Aimeos\Admin\JQAdm\Popup\Media\Property;
...
{
	/** admin/jqadm/popup/media/property/name
	 * Name of the property subpart used by the JQAdm popup media implementation
	 *
	 * Use "Myname" if your class is named "\Aimeos\Admin\Jqadm\Popup\Media\Property\Myname".
	...
	{
		/** admin/jqadm/popup/media/property/decorators/excludes
		 ...
		 *
		 *  admin/jqadm/popup/media/property/decorators/excludes = array( 'decorator1' )
		 *
		 ...
		 * @see admin/jqadm/popup/media/property/decorators/global
		 * @see admin/jqadm/popup/media/property/decorators/local
		 */

		/** admin/jqadm/popup/media/property/decorators/global
		 ...
		 *
		 *  admin/jqadm/popup/media/property/decorators/global = array( 'decorator1' )
		 *
		 ...
		 * @category Developer
		 * @see admin/jqadm/common/decorators/default
		 * @see admin/jqadm/popup/media/property/decorators/excludes
		 * @see admin/jqadm/popup/media/property/decorators/local
		 */

		/** admin/jqadm/popup/media/property/decorators/local
		 ...
		 *
		 *  admin/jqadm/popup/media/property/decorators/local = array( 'decorator2' )
		 *
		 ...
		 * @see admin/jqadm/popup/media/property/decorators/global
		 */
		return $this->createSubClient( 'popup/media/property/' . $type, $name );
	}
	...
	{
		/** admin/jqadm/popup/media/property/subparts
		 * List of JQAdm sub-clients rendered within the popup media property section
		 *
		 ...
		 * @category Developer
		 */
		return $this->getContext()->getConfig()->get( 'admin/jqadm/popup/media/property/subparts', [] );
	}
	 ...
	 */
	protected function toArray( \Aimeos\MShop\Popup\Item\Iface $item, array $data, bool $copy = false ) : array
	{
		$idx = 0;
		$siteId = $this->getContext()->getLocale()->getSiteId();
	...
	{
		/** admin/jqadm/popup/media/property/template-item
		 ...
		 * @category Developer
		 */
		$tplconf = 'admin/jqadm/popup/media/property/template-item';
		$default = 'popup/item-media-property-standard';
