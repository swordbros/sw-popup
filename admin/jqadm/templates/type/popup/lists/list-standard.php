...
/** admin/jqadm/type/popup/lists/fields
 ...
 * e.g. "popup.lists.type.id" for the popup type ID.
 *
 * @param array List of field names, i.e. search keys
 * @since 2017.10
 * @category Developer
 */
$default = ['popup.lists.type.domain', 'popup.lists.type.status', 'popup.lists.type.code', 'popup.lists.type.label'];
$default = $this->config( 'admin/jqadm/type/popup/lists/fields', $default );
$fields = $this->session( 'aimeos/admin/jqadm/type/popup/lists/fields', $default );
...
$columnList = [
	'popup.lists.type.id' => $this->translate( 'admin', 'ID' ),
	'popup.lists.type.domain' => $this->translate( 'admin', 'Domain' ),
	'popup.lists.type.status' => $this->translate( 'admin', 'Status' ),
	'popup.lists.type.code' => $this->translate( 'admin', 'Code' ),
	'popup.lists.type.label' => $this->translate( 'admin', 'Label' ),
	'popup.lists.type.position' => $this->translate( 'admin', 'Position' ),
	'popup.lists.type.ctime' => $this->translate( 'admin', 'Created' ),
	'popup.lists.type.mtime' => $this->translate( 'admin', 'Modified' ),
	'popup.lists.type.editor' => $this->translate( 'admin', 'Editor' ),
];
...
<div class="list-view"
	data-domain="popup/lists/type"
	data-filter="<?= $enc->attr( $this->session( 'aimeos/admin/jqadm/type/popup/lists/filter', new \stdClass ) ) ?>"
	data-items="<?= $enc->attr( $this->get( 'items', map() )->call( 'toArray' )->all() ) ?>">

	<nav class="main-navbar">

		<span class="navbar-brand">
			<?= $enc->html( $this->translate( 'admin', 'Popup Lists Types' ) ) ?>
	...
	<nav-search v-bind:show="search" v-on:close="search = false"
		...
		v-bind:filter="<?= $enc->attr( (object) $this->session( 'aimeos/admin/jqadm/type/popup/lists/filter', new \stdClass ) ) ?>"
	...
	<?= $this->partial(
			...
			'page' => $this->session( 'aimeos/admin/jqadm/type/popup/lists/page', [] )]
		);
	?>

	<form ref="form" class="list list-popup-lists-type" method="POST"
				...
				<thead class="list-header">
					<tr>
						...
						<?= $this->partial(
								...
								['fields' => $fields, 'params' => $params, 'data' => $columnList, 'sort' => $this->session( 'aimeos/admin/jqadm/type/popup/lists/sort' )]
							);
						?>
				...
				<tbody>
					...
					<?= $this->partial(
						$this->config( 'admin/jqadm/partial/listsearch', 'common/partials/listsearch-standard' ), [
							'fields' => array_merge( $fields, ['select'] ), 'filter' => $this->session( 'aimeos/admin/jqadm/type/popup/lists/filter', [] ),
							'data' => [
								'popup.lists.type.id' => ['op' => '=='],
								'popup.lists.type.domain' => ['op' => '==', 'type' => 'select', 'val' => [
								...
								'popup.lists.type.status' => ['op' => '==', 'type' => 'select', 'val' => [
									'1' => $this->translate( 'mshop/code', 'status:1' ),
									'0' => $this->translate( 'mshop/code', 'status:0' ),
									'-1' => $this->translate( 'mshop/code', 'status:-1' ),
									'-2' => $this->translate( 'mshop/code', 'status:-2' ),
								]],
								'popup.lists.type.code' => [],
								'popup.lists.type.label' => [],
								'popup.lists.type.position' => ['op' => '>=', 'type' => 'number'],
								'popup.lists.type.ctime' => ['op' => '-', 'type' => 'datetime-local'],
								'popup.lists.type.mtime' => ['op' => '-', 'type' => 'datetime-local'],
								'popup.lists.type.editor' => [],
							]
						] );
					?>
